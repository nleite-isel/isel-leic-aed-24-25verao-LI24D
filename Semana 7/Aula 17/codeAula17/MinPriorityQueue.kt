...
/**
 * Pre-conditions: The Priority queue elements cannot be null (only the free positions contain null).
 * @return
 */
...
private fun MinPriorityQueue.decreaseKey(k: Int) {
    ...
    while (k > 1) {
        ...
        if (!less(pq[k]!!, pq[idxParent]!!)) // !! operator "double bang" or not-null assertion operator.
                                             // The contents are not null
